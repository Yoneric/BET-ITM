...
ADD CONSTRAINT FK_LIMITE
   FOREIGN KEY (ID_LIMITE)
   REFERENCES LIMITES(ID);

ALTER TABLE USUARIOS
ADD CONSTRAINT FK_bono
   FOREIGN KEY (ID_bono)
   REFERENCES bonoS(ID);
...
ADD CONSTRAINT FK_DETALLE
   ...
   REFERENCES DETALLES_APUESTAS(ID);
...
ADD CONSTRAINT FK_MEDIOS_DE_PAGO
   FOREIGN KEY (ID_DEPOSITOS)
   REFERENCES DEPOSITOS(ID);
   
   
ALTER TABLE COMPROBANTES
ADD CONSTRAINT FK_RETIROS
   FOREIGN KEY (ID_RETIROS)
   REFERENCES RETIROS(ID);
